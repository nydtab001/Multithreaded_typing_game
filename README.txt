...
The purpose of this project is to create a 2D typing game using multithreading, that displays random words to be typed before reaching the bottom. The random words data is genrated from an input dictionary file.
...
The output files will also be found in the main folder.